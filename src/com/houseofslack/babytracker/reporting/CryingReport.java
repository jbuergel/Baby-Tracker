...
public class CryingReport extends DurationReport
{
    @Override
    protected DataProvider.EventType getEventType()
    {
        return DataProvider.EventType.CRYING;
    }
    ...
    {
        return babyIndex == 0 ? 
            new String[] {UpdateService.LEFT_CRYING_START, UpdateService.LEFT_CRYING_END} :
            new String[] {UpdateService.RIGHT_CRYING_START, UpdateService.RIGHT_CRYING_END};
    }
}
