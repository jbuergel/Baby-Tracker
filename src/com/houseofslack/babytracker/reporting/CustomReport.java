...
public class CustomReport extends DurationReport
{
    @Override
    protected DataProvider.EventType getEventType()
    {
        return DataProvider.EventType.CUSTOM;
    }
    ...
    {
        return babyIndex == 0 ? 
            new String[] {UpdateService.LEFT_CUSTOM_START, UpdateService.LEFT_CUSTOM_END} :
            new String[] {UpdateService.RIGHT_CUSTOM_START, UpdateService.RIGHT_CUSTOM_END};
    }
}
