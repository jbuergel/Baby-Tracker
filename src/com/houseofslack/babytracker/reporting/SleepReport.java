...
public class SleepReport extends DurationReport
{
    @Override
    protected DataProvider.EventType getEventType()
    {
        return DataProvider.EventType.SLEEP;
    }
    ...
    {
        return babyIndex == 0 ? 
            new String[] {UpdateService.LEFT_SLEEP_START, UpdateService.LEFT_SLEEP_END} :
            new String[] {UpdateService.RIGHT_SLEEP_START, UpdateService.RIGHT_SLEEP_END};
    }
}
