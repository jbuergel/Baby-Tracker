...
public class FeedingReport extends ReportBase
{
    protected DataProvider.EventType getEventType()
    {
        return DataProvider.EventType.FEEDING;
    }
    ...
    {
        return babyIndex == 0 ? 
            new String[] {UpdateService.LEFT_FEEDING_TIME, UpdateService.PREVIOUS_LEFT_FEEDING_TIME} :
            new String[] {UpdateService.RIGHT_FEEDING_TIME, UpdateService.PREVIOUS_RIGHT_FEEDING_TIME};
    }
}
